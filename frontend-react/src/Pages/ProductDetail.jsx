      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-4">
          <div className="aspect-square bg-stone-100 overflow-hidden relative">
            <img
              src={product.image || product.image_url || `https://picsum.photos/seed/${product.id}/600/600`}
              alt={product.name}
        ...
        <div className="space-y-6">
          {product.category && (
            <p className="font-body text-xs font-semibold tracking-widest text-amber-600 uppercase">{typeof product.category === 'string' ? product.category : product.category?.name}</p>
          )}
